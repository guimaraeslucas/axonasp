...
<head>
	...
	<style>
		...
		code { background: #e9ecef; padding: 2px 5px; }
	</style>
</head>
<body>

<h1>Mathematical and Logical Operators Test</h1>
...
<hr>
<p><strong>Summary:</strong> All mathematical and logical operators are working correctly!</p>
