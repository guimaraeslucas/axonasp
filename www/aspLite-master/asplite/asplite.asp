...
class cls_asplite
	...
	Private Sub Class_Initialize()
		...
		'this is the very first code that is executed
		'it's a start to protect against brute force attacks in a MVC environment
		blockURL=Request.ServerVariables("query_string")		
