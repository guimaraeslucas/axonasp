...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <div class="intro">
                <p>
                    Tests date/time, string, math, type conversion and
            ...
            Response.Write("Month: " & Month() & "<br>")
            Response.Write("Day: " & Day() & "<br>")
            Response.Write("Hour: " & Hour() & "<br>")
            Response.Write("Minute: " & Minute() & "<br>")
            Response.Write("Second: " & Second() & "<br>")
