...
Set obj = Server.CreateObject("System.Security.Cryptography.SHA512CryptoServiceProvider")
If IsObject(obj) Then
    hashBytes = obj.ComputeHash("axonasp")
    Response.Write "SHA512.HashSize=" & obj.HashSize & vbCrLf
End If
Call PrintResult("System.Security.Cryptography.SHA512CryptoServiceProvider")

Set obj = Server.CreateObject("CRYPTO")
If IsObject(obj) Then
    Response.Write "CRYPTO.SHA512=" & Left(obj.SHA512("axonasp"), 16) & vbCrLf
    Call obj.SetBcryptCost(13)
    Response.Write "CRYPTO.BcryptCost=" & obj.BcryptCost & vbCrLf
End If
Call PrintResult("CRYPTO")
%>
