...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <div class="intro">
                <p>
                    Tests VBScript keywords like Empty, Null, Nothing, True,
                    False and verification functions.
                </p>
            </div>
            <div class="result">
                <%
                ...
                Dim someObj
                Set someObj = Server.CreateObject("Scripting.Dictionary")
                If someObj Is Not Nothing Then
