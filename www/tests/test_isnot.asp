...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <div class="intro">
                <p>
                    Tests the Is Not operator for object comparison and
                    Document.Write vs Document.WriteSafe methods.
                </p>
            </div>
            ...
            <%
            Dim obj
            ' obj is Empty (uninitialized) -- use IsEmpty, not Is Nothing.
            ' Note: "obj Is Nothing" on an uninitialized (Empty) variable raises
            ' Type Mismatch (800A000D) in Classic ASP/VBScript because the Is operator
            ' requires object references on both sides. Use IsEmpty() for unassigned checks.
            If IsEmpty(obj) Then
                Response.Write "Case 1: obj is Empty/uninitialized (Correct)<br>"
            Else
                Response.Write "Case 1: Fail<br>"
            End If
            ...
            <%
            Response.Write "<b>Bold Text</b>"
            %>

            <p>
                Document.WriteSafe (Encoded): Should show the HTML code literal.
            </p>
            <%
            Response.Write Server.HTMLEncode("<b>This HTML code is visible, not rendered</b>")
            %>
        </div>
    </body>
</html>
