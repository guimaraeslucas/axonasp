...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <div class="intro">
                <p>
                    Tests email sending capabilities using the integrated
                    gomail.v2 library.
                </p>
                <p>
                    Check the <code>.env</code> file for "Standard" mode
                    configuration.
                </p>
            </div>
            ...
            <div class="box">
                ...
                To2 = "recipient@example.com"
                subject = "Test Email from Go ASP (Manual)"
                body = "<h1>Hello!</h1><p>This is a test email sent manually.</p>"
                isHtml = True

                Response.Write("Target: " & To & "<br>")
                Mail = Server.CreateObject("G3MAIL")
                ' Call Mail.Send
                result = Mail.Send(host, port, username, password, from, To2, subject, body, isHtml)
            ...
            <div class="box">
                ...
                <p>
                    Tentando enviar usando variáveis de ambiente (SMTP_HOST,
                    etc)...
                </p>
                <%
