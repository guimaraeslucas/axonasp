...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <div class="intro">
                <p>
                    Tests dynamic array creation with ReDim, ReDim Preserve,
                    multi-dimensional arrays and VarType for arrays.
                </p>
            </div>
            <div class="box">
                <%
