...
Set txt = fso.CreateTextFile(srcDir & "/hello.txt", True)
txt.WriteLine "Hello from G3FC!"
txt.Close
Set txt = Nothing

Set txt = fso.CreateTextFile(srcDir & "/notes.txt", True)
txt.WriteLine "This is a test file."
txt.Close
Set txt = Nothing
