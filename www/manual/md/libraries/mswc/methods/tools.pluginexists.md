...
## Overview
Calls the PluginExists member on the Tools compatibility object.

## Syntax
```asp
Dim obj
Set obj = Server.CreateObject("MSWC.Tools")
ok = obj.PluginExists(pluginName)
```
...
## Remarks
- Compatibility stub currently returns False.
