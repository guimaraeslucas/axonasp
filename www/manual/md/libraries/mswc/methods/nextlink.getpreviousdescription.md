...
## Overview
Calls the GetPreviousDescription member on the NextLink compatibility object.

## Syntax
```asp
Dim obj
Set obj = Server.CreateObject("MSWC.NextLink")
text = obj.GetPreviousDescription(listFile)
```
...
## Remarks
- Returns description of previous entry.
...
result = obj.GetPreviousDescription()
On Error GoTo 0
