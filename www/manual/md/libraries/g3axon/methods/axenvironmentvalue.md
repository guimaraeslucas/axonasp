# Axenvironmentvalue Method

## Overview

Returns an environment variable value with optional default fallback when the variable is not found.

## Syntax

```asp
result = obj.Axenvironmentvalue(...)
```
