...
<head>
    ...
    <title>G3pix AxonASP - Debug Tools Test</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .debug-section { border-left: 4px solid #28a745; padding: 15px; margin: 15px 0; background: #f9f9f9; border-radius: 4px; }
    </style>
</head>
<body>
    <div class="container">
        <h1>G3pix AxonASP - Debug Tools Test</h1>
        <div class="intro">
            <p>Debug utilities and variable inspection tools.</p>
        </div>
    ...
    <%
        ...
        Response.Write "<p>Modo Debug ativado.</p>"
        Response.Write "<p>Teste de variáveis e inspeção.</p>"
        Dim z
        z = 42/0
        Response.Write "<p>Variável z: " & z & "</p>"
    %>
        </div>
    </div>
</body>
