...
// Package main provides the no-op G3AxonLive endpoint stub for the FastCGI server used when
// the lib_g3axonlive_disabled build tag is set. No routes are registered, no goroutines
// are spawned, and no memory is allocated for the library.
package main
